...
'
  'difec_ron' 'waitForControl; roslaunch difec_ron formation_control.launch use_raw_measurements:=false formation_file:='$(rospack find difec_ron)'/config/formation_rw.csv
'
